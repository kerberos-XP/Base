...
public final class GranDecimal extends BigDecimal {
    ...
    /**
     * Divide un dividendo con un divisor de tipo GranDecimal redondeando el cociente sin decimales.
     *
    ...
    /**
     * Divide un dividendo con un divisor de tipo GranDecimal redondeando el cociente con los decimales estándar.
     *
     * @param divisor es el divisor de tipo GranDecimal
     * @return un cociente de la operación sin decimales
     */
    ...
    /**
     * Redondea un decimal hacia arriba, a la cantidad de decimales máximos utilizados en el sistema (4).
     *
     * @return
     */
    ...
    /**
     * Redondea un valor según el redondeo recibido. EJ: Si está configurado en 10 el redondeo, el monto $14536.49 se
     * transformaría en $14540
     *
    ...
    /**
     * Retorna la cantidad total de digitos del número, incluyendo sus decimales representativos
     *
     * @return
     */
     ...
     *
     * @param monto monto como texto, el separador decimal puede ser la coma o el punto
     * @return
     */
