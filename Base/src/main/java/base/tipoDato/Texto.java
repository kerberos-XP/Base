...
public class Texto {
    ...
    /**
     * Corta espacios en los extremos y convierte todos las letras a mayúscula, luego asigna.
     *
     ...
     * @return error si el texto supera el largo permitido, sin error de lo contrario
     */
     ...
     *
     * @param minimo es el minimo de caracteres que debe tener una cadena de String
     * @return Error si el String en menor al minimo y Sin Error si el String es mayor
     */
    ...
    /**
     * Comprueba si largo de texto esta entre mínimo y máximo recibidos como parámetro.
     *
     ...
     * @return error si el texto no cumple con alguna restricción de largo, sin error de lo contrario
     */
    ...
    /**
     * Formatea la cadena de texto como título. La letra inicial de cada palara con Mayúscula soportando puntos y comas
     * Ej: "Hola Mundo, Java.".
     *
    ...
    /**
     * Formatea la cadena de texto como título. La letra inicial de cada palara con Mayúscula Ej: "Este Es Mi Titulo".
     *
